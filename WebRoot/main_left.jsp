	...
	<div class="menu">
		<div class="menuParent">
			...
			<div class="menuList">
				...
				<div> <a  target="main_right" href="ZdxuqiuAction!showZdxuqiuListadmin.action">浏览需求</a> </div>
				<div> <a  target="main_right" href="${pageContext.request.contextPath}/chart.jsp">图表展示</a> </div>
				<!--  
				<div> <a  target="main_right" href="${pageContext.request.contextPath}/admin/xuqiuServlet?method=Shenhe">需求审核</a> </div>
				-->
				<div> <a  target="main_right" href="${pageContext.request.contextPath}/retrieval.jsp ">综合检索</a> </div>
			...
			<div class="ListTitle">
				...
				<div><a target="main_right" href="LoginAction!showuserListadmin.action">权限管理</a></div>
				<div><a target="main_right" href="power.jsp">权限管理2</a></div>
